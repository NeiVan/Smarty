...
<script type="text/javascript" src="/{$_lang.admin_path}/template/plugins/My97DatePicker/WdatePicker.js"></script>
...
<div id="dcLeft">
 ...
 <ul> 
  ...
  <ul>
   <li {if $module=='flynumber'}class="cur"{/if}><a href="/{$_lang.admin_path}/?m=flynumber"><i class="flynumber"></i><em>无人机序列号管理</em></a></li>
   <li {if $module=='flydata'}class="cur"{/if}><a href="/{$_lang.admin_path}/?m=flydata"><i class="flydata"></i><em>飞行数据管理</em></a></li>
  </ul>
