    ...
    if (!function_exists('exec')) {
        ...
        if (empty($imgsmain)) {
            ...
            try {
                ...
                //存储数据
                $worksmain['pk_user_main'] = intval($user['pk_user_main']);
                ...
                $worksmain['privacy_flag'] = 0;
                $worksmain['privacy_password'] = NULL;
                $worksmain['hidelogo_flag'] = 0;
                $worksmain['hideuser_flag'] = 0;
                $worksmain['flag_publish'] = 1;
                $worksmain['browsing_num'] = 0;
                $worksmain['praised_num'] = 0;
                $worksmain['hideshare_flag'] = 0;
                $worksmain['hidevrglasses_flag'] = 0;
                $worksmain['hideprofile_flag'] = 0;
                $worksmain['hidepraise_flag'] = 0;
                $worksmain['hideviewnum_flag'] = 0;
                $worksmain['create_time'] = date("Y-m-d H:i:s", Common::gmtime());
                $worksmain['sort'] = 999;
                $worksmain['recommend'] = 0;
                $worksmain['user_sort'] = 999;
                $worksmain['user_recommend'] = 0;
                ...
                $panoconfig['scenechoose'] = 1;
                $panoconfig['hotspot'] = '{}';
                $panoconfig['autorotate'] = 1;
